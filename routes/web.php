...
Route::get('/', 'CommonController@view_index1');

Route::get('/index', 'CommonController@view_index');
Route::get('/index1', 'CommonController@view_index1');
Route::post('/index', ['as' => 'index','uses'=>'CommonController@update_video']);
Route::post('/fetchlocation', ['as' => 'fetchlocation','uses'=>'CommonController@fetchlocation']);

Route::get('/manage-allitem', 'CommonController@manage_allitem');
...
Route::get('/searchajaxhotel',array('as'=>'searchajaxhotel','uses'=>'DefaultController@autoComplete'));
/* profile settings */
...
Route::get('/shopstore/{slug}/{share_item_slug?}/{social_media_type?}', 'CommonController@view_single_item1');
...
Route::get('/shopstore/{slug}', 'CommonController@view_single_item1');  // it is store itself ,it is hotel or restarant 
Route::get('/shopdesigner/{slug}', 'CommonController@view_single_shopdesigner');  // it is store itself ,it is hotel or restarant 
Route::get('/item1/{slug}', 'CommonController@view_single_item'); // original 
Route::get('/item/{slug}/{social_media_type?}', 'CommonController@view_single_item_product'); 
Route::get('/item/{id}/{favorite}/{liked}', 'ItemController@view_favorite_item');
Route::post('/fetchroomproducthotel','CommonController@fetchroomproducthotel'); 
Route::post('/fetchroomproducthotelshop','CommonController@fetchroomproducthotelshop'); 
...
Route::get('/shop1', 'CommonController@view_all_items');
Route::get('/shop', 'CommonController@view_all_items1');

Route::get('/shop/{hotelid}/{miles}/{roomtype}/{product_item_top}', 'CommonController@view_all_items1');
Route::get('/shop/{hotelid}/{miles}/{roomtype}', 'CommonController@view_all_items1');
Route::get('/shop/{vendorid}', 'CommonController@shopview_all_items1');
Route::post('/shop1', ['as' => 'shop1','uses'=>'DefaultController@view_shop_items']);
Route::post('/shop', ['as' => 'shop','uses'=>'CommonController@view_shop_items']);
...
/* productcartcart */
Route::get('/procart', 'ProductController@show_cart');
 Route::get('/procart/{ord_id}', 'ProductController@remove_cart_item');
 Route::post('/procart', ['as' => 'procart','uses'=>'ProductController@view_cart']);
 Route::post('/procoupon', ['as' => 'procoupon','uses'=>'ProductController@view_coupon']);
 Route::get('/procart/{remove}/{coupon}', 'ProductController@remove_coupon');
/* cart */
...
Route::get('/procheckout', 'ProductController@show_checkout');
Route::post('/procheckout', ['as' => 'procheckout','uses'=>'ProductController@view_checkout']);
...
Route::get('/psuccess/{ord_token}', 'ProductController@paypal_success');
Route::get('/cancel', 'CommonController@payment_cancel');
Route::get('/psuccess', 'ProductController@view_success');
/* success */
...
Route::group(['middleware' => ['is_admin', 'XSS']], function () {
	...
	Route::get('/admin/manufacturers', 'Admin\ManufacturersController@manufacturers');
	Route::get('/admin/add-manufacturers', 'Admin\ManufacturersController@add_manufacturers')->name('admin.add-manufacturers');
	Route::post('/admin/add-manufacturers', 'Admin\ManufacturersController@save_manufacturers');
	Route::get('/admin/manufacturers/{manufacturers_id}', 'Admin\ManufacturersController@delete_manufacturers');
	Route::get('/admin/edit-manufacturers/{manufacturers_id}', 'Admin\ManufacturersController@edit_manufacturers')->name('admin.edit-manufacturers');
	Route::post('/admin/edit-manufacturers', ['as' => 'admin.edit-manufacturers','uses'=>'Admin\ManufacturersController@update_manufacturers']);
	/* manufacturers */
	...
	Route::get('/admin/paymentsetting/{id}', 'Admin\VendorpaymentController@paymentsetting')->name('admin.paymentsetting');
	Route::post('/admin/vppayment-settings', ['as' => 'admin.vppayment-settings','uses'=>'Admin\VendorpaymentController@update_payment_settings']);
	...
	Route::post('/admin/delete-general-settings-water', ['as' => 'admin.deletewatermark','uses'=>'Admin\SettingsController@delete_general_settings_watermark']);
	...
	/* category */
	//Route::post('/admin/add-subcategory-ajax', 'admin\categorycontroller@save_subcategory_ajax')->name('admin.add-subcategory-ajax');
	Route::post('/admin/add-subcategory-ajax',['as' => 'admin.add-subcategory-ajax','uses'=>'Admin\CategoryController@save_subcategory_ajax']);
...
Route::get('/admin/tag', 'Admin\TagController@tag');
	Route::get('/admin/add-tag', 'Admin\TagController@add_tag')->name('admin.add-tag');
	Route::post('/admin/add-tag', 'Admin\TagController@save_tag');
	Route::get('/admin/tag/{tag_id}', 'Admin\TagController@delete_tag');
	Route::get('/admin/edit-tag/{tag_id}', 'Admin\TagController@edit_tag')->name('admin.edit-tag');
	Route::post('/admin/edit-tag', ['as' => 'admin.edit-tag','uses'=>'Admin\TagController@update_tag']);
	Route::post('/admin/add-tag-ajax',['as' => 'admin.add-tag-ajax','uses'=>'Admin\TagController@save_tag_ajax']);
	/* tag */
	/* blog */
	...
	Route::get('/admin/itemsr/{rvybeex}/{token}', 'Admin\ItemController@rvybe_item_request');
	/* items */


		/*  hotels producr that is item*/
	
	Route::get('/admin/shopItems', 'Admin\ShopitemController@view_items');
	Route::get('/admin/upload-shopItems/{itemtype}', 'Admin\ShopitemController@upload_item');
	Route::post('/admin/upload-shopItems', ['as' => 'admin.upload-shopitem','uses'=>'Admin\ShopitemController@save_items']);


	Route::get('/admin/edit-shopItems/{token}', 'Admin\ShopitemController@edit_item');
    Route::get('/admin/edit-shopItems/{dropimg}/{token}', 'Admin\ShopitemController@drop_image_item');
    Route::post('/admin/edit-shopItems', ['as' => 'admin.edit-shopitem','uses'=>'Admin\ShopitemController@update_items']);
	Route::get('/admin/shopItems/{token}', 'Admin\ShopitemController@delete_item_request');
	Route::get('/admin/shopItems/{featured}/{token}', 'Admin\ShopitemController@featured_item_request');
	Route::post('/admin/fetch-vendor-hotel-room',['as' => 'admin.fetch-vendor-hotel-room','uses'=>'Admin\ProductController@fetch_vendor_hotel_room']);
	//Route::post('/admin/fetch-hotel-room',['as' => 'admin.fetch-hotel-room','uses'=>'Admin\ShopitemController@fetch_hotel_room']);
	/* items */


		/* items  NEW product UI*/
	
	Route::get('/admin/upload-newitems', 'Admin\ProductController@view_newitems');
	Route::get('/admin/upload-new-item/{token}', 'Admin\ProductController@upload_item');
	Route::post('/admin/upload-new-item', ['as' => 'admin.upload-new-item','uses'=>'Admin\ProductController@save_items']);
	Route::get('/admin/edit-newItems/{token}', 'Admin\ProductController@edit_item');
	 Route::post('/admin/edit-newItems', ['as' => 'admin.edit-newitems','uses'=>'Admin\ProductController@update_items']);
	 Route::get('/admin/newpItems/{token}', 'Admin\ProductController@delete_item_request');
	 Route::get('/admin/newpItems/{rvybeex}/{token}', 'Admin\ProductController@featured_item_request');
	  Route::get('/admin/edit-product/{dropimg}/{token}', 'Admin\ProductController@drop_image_item');
	//Route::get('/admin/newpItems/{featured}/{token}', 'Admin\ProductController@rvybe_item_request');
	Route::get('/admin/newpItemsr/{rvybeex}/{token}', 'Admin\ProductController@rvybe_item_request');
 ...
 //    Route::post('/admin/edit-item', ['as' => 'admin.edit-item','uses'=>'Admin\ItemController@update_items']);
	...
	Route::get('/admin/designers', 'Admin\DesignerController@view_designer');
	Route::get('/admin/upload-designer', 'Admin\DesignerController@upload_designer');
	Route::post('/admin/upload-designer', ['as' => 'admin.upload-designer','uses'=>'Admin\DesignerController@save_designer']);
	
	
	Route::get('/admin/edit-designer/{id}', 'Admin\DesignerController@edit_designer');
 	//    Route::get('/admin/edit-item/{dropimg}/{token}', 'Admin\ItemController@drop_image_item');
    Route::post('/admin/edit-designer', ['as' => 'admin.edit-designer','uses'=>'Admin\DesignerController@update_designer']);
	 Route::get('/admin/designers/{id}', 'Admin\DesignerController@delete_designer_request');
	// Route::get('/admin/items/{featured}/{token}', 'Admin\ItemController@featured_item_request');
	/* designerDetail */
	...
	Route::get('/admin/productss-import-export/{type1}', 'Admin\ImportExportController@download_products_export1');
	Route::get('/admin/vendor-import-export/{type}', 'Admin\ImportExportController@download_vendor_export');

	Route::get('/admin/vendor-import-export', 'Admin\ImportExportController@view_vendor_import_export');
	Route::post('/admin/vendor-import-export', ['as' => 'admin.vendor-import-export','uses'=>'Admin\ImportExportController@vendor_import']);
	/* product import & export */


	Route::get('/admin/items-import-export', 'Admin\ImportExportController@view_item_import_export');
	Route::post('/admin/items-import-export', ['as' => 'admin.items-import-export','uses'=>'Admin\ImportExportController@items_import']);
	Route::get('/admin/items-import-export/{type}', 'Admin\ImportExportController@download_items_export');
