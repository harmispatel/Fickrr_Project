...
class CategoryController extends Controller
{
  ...
  public function edit_category($cat_id)
	...
	//    echo "<pre>";
	//    print_r($categoryData['category']);exit;
	  // $categoryData['subcategory'] = Category::allsubcategoryData();

	// echo "<pre>";print_r($categoryData['subcategory']);exit;
	...
	public function save_subcategory(Request $request)
	{
		...
		$data = array('cat_id' => $cat_id, 'subcategory_name' => $subcategory_name, 'subcategory_slug' => $subcategory_slug, 'subcategory_status' => $subcategory_status,'subcatparent_id'=>$subcatparent_id);
  ...
  public function save_subcategory_ajax(Request $request)
	{
		...
		$returnArray = array('success'=>1, 'message'=>'Insert successfully.');
  ...
  public function edit_subcategory($subcat_id)
	{
	   ...
	   //echo "<pre>";print_r($edit['subcategory']);exit;
