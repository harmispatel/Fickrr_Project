                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           @else
                        <form action="{{ route('admin.upload-designer') }}" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @endif
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ trans('labels.designername')}}<span class="require">*</span></label>
                                                 <input type="text" name="designername" id="designername"   placeholder="{{ trans('labels.designername')}}" required="true"  value="" class="form-control" >
                                            </div> 
