                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           @else
                           <form action="{{ route('admin.vppayment-settings') }}" method="post" enctype="multipart/form-data">
                           {{ csrf_field() }}
                          @endif
                        ...
                        <input type="hidden"  name="sid" id="sid" value="@if(!empty($setting['setting'])) {{ $setting['setting']->sid }} @endif" />  
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(5724,$translate) }} </label><br/>
