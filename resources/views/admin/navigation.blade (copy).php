                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li class="menu-item-has-children dropdown dropdown-submenu"><a href="#" class="dropdown-toggle"><i class="fa fa-gear"></i> test</a>
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="fa fa-gear"></i><a href="{{ url('/admin/general-settings') }}">test1</a></li>
                                    <li><i class="fa fa-gear"></i><a href="{{ url('/admin/color-settings') }}">test1</a></li>
                                </ul>
                            </li>
                   ...
                   <li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/items') }}">{{ trans('labels.VendorStore') }}</a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/item-type') }}">{{ trans('labels.roomtype')}}</a></li>
                            <!-- <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/shopItems') }}">{{ Helper::translation(5442,$translate) }}</a></li> -->
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/designers') }}">{{trans('labels.designers') }}</a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/orders') }}">{{ Helper::translation(5619,$translate) }}</a></li>
                             <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/upload-newitems') }}">Products</a></li>
                             <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/tag') }}">{{ trans('labels.tag') }}</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                            <i class="menu-icon fa fa-location-arrow"></i>{{ trans('labels.VendorStore') }}
                        </a>
                        <ul class="sub-menu children dropdown-menu">
                                <li class="menu-item-has-children dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-location-arrow"></i>ff{{ trans('labels.VendorStore') }}</a>
                                    <ul class="sub-menu children dropdown-menu">
                                             <li><i class="menu-icon fa fa-location-arrow"></i><a href="{{ url('/admin/items') }}">{{ trans('labels.VendorStore') }}</a></li>
