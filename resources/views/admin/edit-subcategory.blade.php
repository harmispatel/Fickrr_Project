            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(5256,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @foreach($categoryData['category'] as $category)
                                                    <option value="{{ $category->cat_id }}" class="selctedcls" @if($edit['subcategory']->cat_id == $category->cat_id)  selected="selected" @endif>{{ $category->category_name }}</option>
                                                      ...
                                                      <?php 
                                                                ...
                                                                if( count ($value) > 0 ){
                                                                    foreach($value as $key=>$value1){ ?>
                                                                        ...
                                                                        <option value="{{ $value1->subcat_id }}_{{ $category->cat_id }}" @if($value1->subcat_id == $edit['subcategory']->subcatparent_id)  selected="selected" @endif> - {{ $value1->subcategory_name }}</option>
