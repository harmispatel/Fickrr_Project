...
<body>
    ...
    @if (in_array('items', $avilable))
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <form action="{{ route('admin.edit-newitems') }}" class="setting_form" id="item_form" method="post"
                            ...
                            <div class="upld-item">
                                <div class="item_title">
                                    <input type="text" name="item_name" size="30" id="item_name" spellcheck="true"
                                        autocomplete="off" class="" placeholder="{{ trans('labels.itemname') }}"
                                        value="{{ $edit['item']->item_name }}">
                                </div>
                                <div class="item_parmalink">
                                    <div class="item-edit-slug-box"><strong>Permalink:</strong>
                                        <a href="#" target="_blank" id="atagpro" onClick="pageRedirectionToslug('{{ @$edit['item']->item_slug }}')"> {{ URL::TO('/item/') }}/<span
                                                id="editable-post-name">{{ @$edit['item']->item_slug }}</span></a>
                                            ...
                                            <button type="button" class="item-edit-slug-btn" id="cacncelbtn"
                                                aria-label="Edit permalink"
                                                onClick="$('#editable-post-name').html('{{ @$edit['item']->item_slug }}');$(this).hide();$('#demo_url').hide();$('#okbtn').hide();$('#demo_url').val('{{ @$edit['item']->demo_url }}')"
                                ...
                                <div class="upld-item-editor"> 
                                    <textarea name="item_desc" id="summary-ckeditor" rows="6" class="form-control"
                                        data-bvalidator="required">{{ html_entity_decode($edit['item']->item_desc) }}</textarea>
                                </div>
                                <div class="upld-item-detail">
                                        ...
                                        <h2 class="hndle ui-sortable-handle">Product data
                                            <span class="type_box hidden"> —
                                                ...
                                                <label for="_virtual" class="show_if_simple tips" style="">
                                                    Virtual:
                                                    <input type="checkbox" name="virtual" id="virtual" value="1" @if ($edit['item']->virtualp == 1) checked="checked" @endif>
                                                </label>
                                                <label for="_downloadable" class="show_if_simple tips" style="">
                                                    Downloadable:
                                                    <input type="checkbox" name="downloadable" id="downloadable"
                                                        value="1" @if ($edit['item']->downloadable == 1) checked="checked" @endif>
                                                ...
                                                <label for="location">
                                                    ...
                                                    <select name="manufacturer" id="manufacturer"
                                                        ...
                                                        @foreach ($manufacturer as $manfact)
                                                            <option value="{{ $manfact->id }}" @if ($edit['item']->manufacturers_id == $manfact->id) selected="selected" @endif>{{ $manfact->name }}</option>
                                    ...
                                    <div class="upld-item-tabs">
                                        <div class="row m-0">
                                                        ...
                                                        <div class="options_group">
                                                            ...
                                                            <p class="form-field _sale_price_field ">
                                                                ...
                                                                <input type="text" class="short wc_input_price" style=""
                                                                    ...
                                                                    value="{{ @$edit['item']->extended_price }}"
                                                                    placeholder="">
                                                            </p>
                                                        </div>
                                                            ...
                                                            <p class="form-field">
                                                                ...
                                                                <select name="hotels[]" id="hotel" class="short"
                                                                    ...
                                                                    @foreach ($hotels as $hotel)
                                                                        ...
                                                                        ->first(); ?>
                                                                        <option value="{{ $hotel->item_id }}" @if (in_array($hotel->item_id, $itemhotel)) selected="selected" @endif>{{ $hotel->item_name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </p>
                                            ...
                                            @foreach ($manufacturer as $manfact)
                                               <option value="{{ $manfact->manufacturers_id }}" @if (in_array($manfact->manufacturers_id, $item_manfact)) selected="selected" @endif >{{ $manfact->manufacturers_name }}</option>
                                            ...
                                            @endforeach
                                                            ...
                                                            <div class="stock_fields" id="stock_fields">
                                                                <p class="form-field _stock_field ">
                                                                    ...
                                                                    <input type="number" class="short wc_input_stock"
                                                                        ...
                                                                        value="{{ @$edit['item']->stock_quantity }}">
                                                                </p>
                                                                <p class="form-field">
                                                                    <label for="backorders">Allow backorders?</label>
                                                                    <select id="backorders" name="backorders"
                                                                        class="select short">
                                                                        <option value="0" @if(@$edit['item']->backorders == 0) selected="selected" @endif>Do not
                                                                            allow</option>
                                                                        <option value="1" @if(@$edit['item']->backorders == 1) selected="selected" @endif>Allow, but notify
                                                                            customer</option>
                                                                        <option value="2" @if(@$edit['item']->backorders == 2) selected="selected" @endif>Allow</option>
                                                                    </select>
                                                                </p>
                                                                <p class="form-field ">
                                                                    ...
                                                                    <input type="number" class="short"
                                                                        ...
                                                                        placeholder="2" value="{{ @$edit['item']->low_stock_amount }}">
                                                                </p>
                                                            </div>
                                                            <p class="form-field">
                                                                    ...
                                                                    <select id="instock" name="instock"
                                                                        class="select short">
                                                                        <option value="0" @if (@$edit['item']->instock == 0) selected="selected" @endif>Out of stock</option>
                                                                        <option value="1" @if (@$edit['item']->instock == 1) selected="selected" @endif>In stock</option>
                                                                        <option value="2" @if (@$edit['item']->instock == 2) selected="selected" @endif>On backorder</option>
                                                                    </select>
                                                            </p>
                                                        </div>
                                                        <div class="options_group">
                                                            <p class="form-field">
                                                                ...
                                                                <input type="checkbox" class="checkbox"
                                                                    ...
                                                                    value="1" @if(@$edit['item']->sold_individually == 1) checked='checked' @endif>
                                                    ...
                                                    <div class="tab-pane fade" id="advanced" role="tabpanel"
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field">
                                                                <label
                                                                    for="_purchase_note">{{ trans('labels.purchasenote') }}</label>
                                ...
                                <div class="upld-item-detail">
                                    ...
                                    <div class="upld-item-detail-body">
                                        ...
                                        <textarea id="editor2" class="ckeditor" name="item_shortdesc"
                                            data-bvalidator="required">{{ html_entity_decode($edit['item']->item_shortdesc) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="upld-item-detail">
                                ...
                                <div id="post-status-select" class="">
                                    <select name="item_status" class="select-custome" id="item_status">
                                        <option  value="1" @if (@edit['item']->item_status == '1') selected="selected" @endif>Yes</option>
                                        <option value="0" @if (@edit['item']->item_status == '0') selected="selected" @endif>no</option>
                                    ...
                                    <div class="misc-pub-section misc-pub-post-status">
                                        Status: <span id="post-status-display">
                                            @if (@$edit['item']->item_status == 1)
                                            Published @else UnPublished @endif
                                        </span>
                                        ...
                                        <div id="post-status-select" class="" style="display:none;">
                                            <select name="item_status" id="item_status" class="select-custome">
                                                <option value="Published" @if (@$edit['item']->item_status == 1) selected="selected" @endif>Yes
                                                </option>
                                                <option value="UnPublished" @if (@$edit['item']->item_status == 0) selected="selected" @endif>no
                                                </option>
                                            </select>
                                    ...
                                    <div class="misc-pub-section misc-pub-visibility" id="visibility">
                                        Visibility: 
                                        <span id="post-visibility-display">@if (@$edit['item']->drop_status == 'yes') No @endif @if (@$edit['item']->drop_status == 'no') Yes @endif </span>
                                        ...
                                        <div id="post-visibility-select" class="" style="display:none;">
                                            <input type="radio" name="drop_status" id="drop_status" value="no"
                                                 @if (@$edit['item']->drop_status == 'yes') checked="checked" @endif> 
                                                <label for="visibility-radio-public" class="selectit">No</label>
                                            <br>
                                                <input type="radio" name="drop_status" id="drop_status" value="yes" @if (@$edit['item']->drop_status == 'no') checked="checked" @endif>Yes
                                            <br>
                                            <p>
                                    ...
                                    <div class="tab-content cat-tab-content">
                                        ...
                                        <li>
                                            <label class="show_if_simple tips" style="">
                                                ...
                                                @foreach ($catgoriesd['menu'] as $menu)
                                                    <li>
                                                        <!-- <input type="radio" name="subcategory" id="subcategory"  value="category_{{ $menu->cat_id }}" /> -->
                                                        {{ $menu->category_name }}
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><input type="checkbox" name="subcategory[]"
                                                                    id="subcategory" value="{{ $value1->subcat_id }}"
                                                                    @if (in_array($value1->subcat_id, $selcategoriesarray)) checked="checked" @endif /> -
                                                                {{ $value1->subcategory_name }}
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><input type="checkbox" name="subcategory[]"
                                                                            id="subcategory"
                                                                            value="{{ $subsubvalue->subcat_id }}" @if (in_array($subsubvalue->subcat_id, $selcategoriesarray)) checked="checked" @endif /> --
                                                                        {{ $subsubvalue->subcategory_name }} </li>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <select name="cat_id" id="cat_id" class="text-form-select"
                                                ...
                                                @foreach ($catgoriesd['menu'] as $menu)
                                                    ...
                                                    <option value="{{ $value1->subcat_id }}_{{ $menu->cat_id }}">
                                                        - {{ $value1->subcategory_name }}</option>
 ...
 -->
                                             @if(count($catgoriesd['tag']) > 0)
                                                        @foreach($catgoriesd['tag'] as $key=>$value)
                                                            <li id="db_{{ $value->tag_id }}">
                                                               <!--  <a href="javascript:void(0)" role="button" class="tag-cloud-link" onclick="addTagItem('<?php //echo $value->tag_name; ?>','<?php //echo $value->tag_id; ?>')">{{ $value->tag_name }}</a> -->

                                            @if(in_array($value->tag_id,@$seltagarray))  
  											...
  											<i class="fa fa-times-circle" aria-hidden="true"></i> @endif
                                                                </button>&nbsp;{{ $value->tag_name }} 

                                                @if(in_array($value->tag_id,@$seltagarray))  <input type="hidden" name="tag_id[]" id="tagstags" value="{{ $value->tag_id }}" /> @endif
                                                            </li>
                                                        @endforeach
                                             @endif
                                ...
                                <div class="upld-item-detail-body">
                                    <div class="item-img-upload">
                                        ...
                                        @if ($edit['item']->item_preview != '')
                                            <img src="{{ url('/') }}/public/storage/items/{{ $edit['item']->item_preview }}"
                                                alt="{{ $edit['item']->item_name }}" class="item-thumb">
                                        @else
                                ...
                                <div class="upld-item-detail-body">
                                    <div class="item-img-upload">
                                        ...
                                        <input type="file" id="item_screenshot" name="item_screenshot[]"
                                            class="files"><small>({{ Helper::translation(2946, $translate) }} :
                                            750x430px)</small><br /><br />

                                        @foreach ($item_image['item'] as $item)

                                            <div class="item-img"><img
                                                    src="{{ url('/') }}/public/storage/items/{{ $item->item_image }}"
                                                    alt="{{ $item->item_image }}" class="item-thumb">
                                                <a href="{{ url('/admin/edit-product') }}/dropimg/{{ base64_encode($item->itm_id) }}"
                                                    onClick="return confirm('{{ Helper::translation(5064, $translate) }}?');"
    ...
    <script type="text/javascript">
        ...
        function pageRedirectionToslug(url){
          ...
          //alert(demourlval);
          // alert(demourlval);
          //  var url="{{ URL::TO('/item/') }}/"+demourlval;
         //  var demourlval1=demourlval.replace('','-');
            // var url="{{ URL::TO('/item/') }}/"+demourlval1;

            var demourlval1=demourlval.split(' ').join('-');

            // console.log(demourlval1);
            window.location.href="{{ URL::TO('/item/') }}/"+demourlval1;
        ...
        function saveSubCategory(objs) {
            ...
            $.ajax({
                url: "{{ route('admin.add-subcategory-ajax') }}",
                type: 'post',
                data: formData,
        ...
        var itemhotel = "{{ implode(',', $itemhotel) }}";
        var itemroom = "{{ implode(',', $itemroom) }}";
       ...
       function removeTagItem(tagid,clsname,tagname,addclsname){
        ...
        $("#hotel").change(function() {
            ...
            jQuery.ajax({
                ...
                url: "{{ url('/admin/fetch-vendor-hotel-room') }}",
                method: 'post',
                data: {

                    //  user_id: vendorid,
                    //sel_hotel:"{{ implode(',', $itemhotel) }}",
                    sel_room: test,
                    sel_hotel: $(this).val(),
