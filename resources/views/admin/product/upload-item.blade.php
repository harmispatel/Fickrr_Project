...
<body>
    ...
    @if (in_array('items', $avilable))
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <form action="{{ route('admin.upload-new-item') }}" class="setting_form" id="item_form" method="post"
                            ...
                            <div class="upld-item">
                                <div class="item_title">
                                    <input type="text" name="item_name" size="30" value="" id="item_name"
                                        ...
                                        placeholder="{{ trans('labels.itemname') }}">
                                </div>
                                <div class="item_parmalink">
                                    <div class="item-edit-slug-box"><strong>Permalink:</strong>
                                        <a href="#"> {{ URL::TO('/item/') }}/<span id="editable-post-name">test</span>
                                        ...
                                        ‎<button type="button" class="item-edit-slug-btn" aria-label="Edit permalink"
                                            id="editbtn"
                                            onClick="$('#demo_url').show();$('#okbtn').show();$('#cacncelbtn').show();$('#demo_url').val($('#editable-post-name').html());$('#editable-post-name').html('');$(this).hide();">Edit</button>
                                        <!-- //demo_url -->
                                    </div>
                                </div>
                                                            ...
                                                            <p class="form-field">
                                                                ...
                                                                <select name="hotels[]" id="hotel" class="short"
                                                                    ...
                                                                    @foreach ($shops as $shop)
                                                                        ...
                                                                        ->first(); ?>
                                                                        <option value="{{ $shop->item_id }}">
                                                                            {{ $shop->item_name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </p>
                                                        </div>
 ...
 -->
                                                            ...
                                                            <li id="db_{{ $value->tag_id }}">
                                                               <!--  <a href="javascript:void(0)" role="button" class="tag-cloud-link" onclick="addTagItem('<?php //echo $value->tag_name; ?>','<?php //echo $value->tag_id; ?>')">{{ $value->tag_name }}</a> -->
                                                                ...
                                                                <button type="button" id="product_tag-check-num-1" class="ntdelbutton" onClick="removeTagItem('<?php echo $value->tag_id; ?>','fa fa-check','<?php echo $value->tag_name; ?>','fa fa-times-circle')">
                                                                        <i class="fa fa-times-circle" aria-hidden="true"></i>
                                                                </button>&nbsp;{{ $value->tag_name }} <input type="hidden" name="tag_id[]" id="tagstags" value="{{ $value->tag_id }}" />
                                                            </li>
                                                        @endforeach
                                                    @endif
                            ...
                            <div class="upld-item-detail">
                                <div class="upld-item-detail-head">
                                    <h2 class="hndle ui-sortable-handle">{{ Helper::translation(2950, $translate) }}
                                    </h2>
                                </div>
                                <div class="upld-item-detail-body">
                                    <div class="item-img-upload">
