            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(2931,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           @else
                        <form action="{{ route('admin.upload-shopitem') }}" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">dfgfdg
                                                <label for="site_title" class="control-label mb-1"> {{ Helper::translation(3142,$translate) }} <span class="require">*</span></label>
                                                <select name="user_id" class="form-control" data-bvalidator="required" onChange="fetchRoomCategory(this.value)">
                                                <option value=""></option>
                                                @foreach($getvendor as $user)
                                            ...
                                            <div class="form-group" id="afteradd">
                                          ...
                                          <!--   <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Hotel Location category<span class="require">*</span></label>
                                                 <select name="hotel_location[]" id="hotel_location[]" class="form-control" data-bvalidator="required" multiple="multiple">
                                                <option value="">Select</option>
                                                @foreach($shops as $menu)
                                                    
                                                    <option value="{{ $menu->item_id }}" >{{ $menu->item_name }}</option>
...
<script type="text/javascript">
    ...
    function fetchRoomCategory(vendorid){
