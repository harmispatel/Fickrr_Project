            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(5211,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" name="user_type" value="admin">
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="socialmedialinks" class="control-label mb-1">{{ trans('labels.socialmedialinksfacebook') }} <span class="require">*</span></label>
                                                    <input name="socialmedialinks" id="socialmedialinks" type="text"  class="form-control"  data-bvalidator="url" required value="{{ @$edit['userdata']->facebook_url }}">
                                                ...
                                                <div class="form-group">
                                                    <label for="instagram" class="control-label mb-1">{{ trans('labels.instagram') }}<span class="require">*</span></label>
                                                    <input name="instagram" id="instagram" type="text"  class="form-control"  data-bvalidator="url" required value="{{ @$edit['userdata']->instagram }}"/>
                                                
                                                </div>
    
                                                 <div class="form-group">
                                                    <label for="linkedin" class="control-label mb-1">{{ trans('labels.twitterurl') }}<span class="require">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="youtube" class="control-label mb-1">{{ trans('labels.youtube') }}<span class="require">*</span></label>
                                                    <input name="youtube" id="youtube" type="text"  class="form-control"  data-bvalidator="url" required value="{{ @$edit['userdata']->youtube }}"/>
                                               ...
                                               <!--  @if(Auth::user()->id == 1)
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="{{ Helper::translation(2944,$translate) }}">@if($edit['userdata']->user_photo != '')
