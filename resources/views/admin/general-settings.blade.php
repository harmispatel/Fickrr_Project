...
@if ($errors->any())
                       ...
                       <div class="card">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                             ...
                             <div class="form-group">
                                                <label for="banner_heading" class="control-label mb-1">{{ Helper::translation(5346,$translate) }} </label>
                                                <input id="site_banner_heading" name="site_banner_heading" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_banner_heading }}" >
                                            </div>  
                                            
                              <div class="form-group">
                                                <label for="banner_heading" class="control-label mb-1">{{ Helper::translation(5349,$translate) }} </label>
                                                <input id="site_banner_subheading" name="site_banner_subheading" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_banner_subheading }}" >
                                            </div>              
                             ...
                             <div class="form-group">
                                            ...
                                            <input type="file" id="site_banner" name="site_banner[]" class="form-control-file" @if($setting['setting']->site_banner == '') required @endif  multiple="multiple" accept="image/jpg, image/jpeg">
                                                ...
                                                <div class="uploaded-img-cls">
                                                    ...
                                                    @foreach(@$sitebanner as $key=>$value)
                                                        <div class="img-close-btn">
                                                            ...
                                                            <img height="30" src="{{ url('/') }}/public/storage/settings/{{ $value }}" />
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @endif
                                            ...
                                            @if($setting['setting']->site_watermark != '')
                                                <img height="150" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->site_watermark }}" id="removeimg"/>
                                            ...
                                            <div class="form-group">
                                                 <label for="site_loader_image" class="control-label mb-1">Staff Favourite Images (200 X 200)<span class="require">*</span></label>
                                                  ...
                                                  <input type="file" id="site_loader_image" name="stafffav_image" class="form-control-file" @if($setting['setting']->stafffav_image == '') data-bvalidator="required,extension[gif,jpg,png,jpeg]" data-bvalidator-msg="{{ Helper::translation(5376,$translate) }}" @else data-bvalidator="extension[gif,jpg,png,jpeg]" data-bvalidator-msg="{{ Helper::translation(5376,$translate) }}" @endif>
                                                @if($setting['setting']->stafffav_image != '')
                                                     <img height="50" src="{{ url('/') }}/public/storage/settings/{{ $setting['setting']->stafffav_image }}" />
                                                @endif
                                              ...
                                              <div class="form-group">
                                                 ...
                                                 <textarea id="staff_fav_content" name="staff_fav_content"  rows="6" class="form-control noscroll_textarea" required minlength="0" maxlength="100">{{  $setting['setting']->staff_fav_content }}</textarea>
                                         ...
                                         <!--    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              <label for="product_approval" class="control-label mb-1">{{ Helper::translation(5385,$translate) }}?<span class="require">*</span></label><br/>                                         
 ...
 -->
                                              <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">{{ trans('labels.calltoactiontext') }}<span class="require">*</span></label>
                                                
                                            <textarea name="calltoactiontext" id="calltoactiontext" rows="6" class="form-control noscroll_textarea" required>{{ $setting['setting']->calltoactiontext}}</textarea>
                                            </div>  
                                                ...
                                                <input type="hidden" name="save_watermark"  id="save_watermark" value="{{ $setting['setting']->site_watermark }}">
                                                <input type="hidden" name="save_loader_image" value="{{ $setting['setting']->site_loader_image }}">
                                                 <input type="hidden" name="save_stafffav_image" value="{{ $setting['setting']->stafffav_image }}">
                                                <input type="hidden" name="sid" value="1">
                                                <input type="hidden" name="cid" id="cid" value="{{ $setting['setting']->sid }}">
...
<script>
    ...
    function Deleteimg(imgname,obj,type){
        ...
        jQuery.ajax({
                ...
                url: "{{ url('/admin/delete-general-settings-water') }}",
                method: 'post',
                data: {
