                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="cat_id" class="form-control" required>
                                                        ...
                                                        @foreach($categoryData['category'] as $category)
                                                            <option value="{{ $category->cat_id }}_0" class="selctedcls">{{ $category->category_name }}</option>
                                                            ...
                                                            <?php 
                                                                ...
                                                                if( count ($value) > 0 ){
                                                                    foreach($value as $key=>$value1){ ?>
                                                                        ...
                                                                        <option value="{{ $value1->subcat_id }}_{{ $category->cat_id }}"> - {{ $value1->subcategory_name }}</option>
