                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           @else
                           <form action="{{ route('admin.edit-shopitem') }}" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           @endif
                                    ...
                                    <div class="card-body">
                                          ...
                                          @endif
                                            ...
                                            <div class="form-group" id="afteradd">
                                                ...
                                                <input type="text" name="location" id="autocomplete" onFocus="geolocate()"  placeholder="Location" data-parsley-required="true"  value="{{ $edit['item']->address }}" class="form-control" >
