...
<!-- <div class="toast-container toast-top-center">
	  <div class="toast mb-3" id="cart-toast-success" data-delay="5000" role="alert" aria-live="assertive" aria-atomic="true">
		...
		<div class="toast-body">Items added</div>
	  </div>
	</div>
 -->
				...
				<div class="details col-md-6">
				  ...
				  @endif
					   ...
					   <?php 
						...
						@else */ ?>
									<input type="hidden" name="item_quantity" id="item_quantity" value="{{ Auth::user()->id }}">
								...
								@if($checkif_purchased == 0)
										...
										@if(Auth::user()->id != 1)
											<button type="submit" class="btn btn-primary btn-shadow btn-block"><i class="dwg-cart font-size-lg mr-2"></i>{{ Helper::translation(3074,$translate) }}</button>
												<button type="button" class="btn btn-primary btn-shadow btn-block" onclick="$('#item_quantity').val($('#quantity').val());$('#order_form').submit();"><i class="dwg-cart font-size-lg mr-2"></i>ff{{ Helper::translation(3074,$translate) }}</button>
										@endif 
							   @endif   
						 <?php 
					  /*  @endif */ ?>
