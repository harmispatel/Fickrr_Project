            ...
            <!--   <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="instagram" name="instagram" class="form-control"  value="{{ $edit['item']->instagram }}">
                </div>
              </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="linkedin" name="linkedin" class="form-control" value="{{ $edit['item']->linkedin }}">
                    </div>
              </div>
              <div class="col-sm-6">
                    <div class="form-group">
