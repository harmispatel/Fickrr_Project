              ...
              <div class="row">
                ...
                <section class="col-lg-8 pt-2 pt-lg-4 pb-4 mb-3">
                  ...
                  //  echo "<pre>";print_r($cart['item']);
                    ...
                    <a class="d-block position-relative mr-3 mb-sm-0 mr-sm-4 cart-img" href="{{ url('/procart') }}/{{ base64_encode($cart->ord_id) }}" onClick="return confirm('{{ Helper::translation(2892,$translate) }}');">
                    ...
                    @endif
                      ...
                      <div class="media-body text-sm-left">
                        <h3 class="h6 product-title mb-2"><a href="{{ url('/item') }}/{{ $cart->item_name }}">{{ $cart->item_name }}</a></h3>

                         <div class="quantity-selecter">
                            <div class="number-input">
                          
                            <span class="quantity" min="0" name="quantity" id="quantity" >{{ $cart->item_qunatity }}</span>
                      ...
                      <a class="d-block position-relative mb-3 mb-sm-0 mr-sm-4 mx-auto cart-img" href="{{ url('/procart') }}/{{ base64_encode($cart->ord_id) }}" onClick="return confirm('{{ Helper::translation(2892,$translate) }}');">
