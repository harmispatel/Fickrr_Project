...
<html lang="en">
<head>
<title>@if($allsettings->site_selling_display == 1) {{ Helper::translation(3018,$translate) }} @else {{ Helper::translation(2860,$translate) }} @endif - {{ $allsettings->site_title }}</title>
@include('meta')
@include('style')
</head>
<body>
