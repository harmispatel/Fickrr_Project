<aside class="col-lg-4">
            <div class="cz-sidebar-static h-100 border-right">
              <h6>{{ Helper::translation(4950,$translate) }}</h6>
            ...
            <div class="item-details badge-size" data-aos="fade-up" data-aos-delay="200">
              ...
              <div data-aos="fade-up" data-aos-delay="200">
              <hr class="my-4">
              <h6 class="pb-1">{{ Helper::translation(3204,$translate) }}</h6>
              <div class="form-group">
                  <input type="text" value="{{ URL::to('/') }}/?ref={{ $user['user']->id }}" id="myInput" class="form-control" readonly="readonly">
                </div>
                <a href="javascript:void(0)" onclick="myFunction()" class="btn btn-primary btn-sm">{{ Helper::translation(3205,$translate) }}</a>
              </div>  
              @endif
              <div data-aos="fade-up" data-aos-delay="200">
              <hr class="my-4">
