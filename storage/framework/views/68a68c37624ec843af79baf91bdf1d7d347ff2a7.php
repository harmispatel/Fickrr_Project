...
<head>
    ...
    <title>Rvybe - Home</title>
    <?php echo $__env->yieldContent('metashare'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/fonts/iconfont/tabler-icons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/vendor/bootstrap/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-slider/10.0.0/css/bootstrap-slider.min.css">
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/vendor/OwlCarousel/assets/owl.carousel.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/vendor/OwlCarousel/assets/owl.theme.default.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/fonts/fonts.css')); ?>">
...
<!-- 
    ...
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/theme/css/font-awesome.min.css')); ?>"> -->
     ...
     <!--  <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/css/theme.min.css')); ?>"> -->
    <link rel="stylesheet" href="<?php echo e(URL::to('resources/views/customtheme/assets/css/style.css')); ?>">

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user/common/meta.blade.php ENDPATH**/ ?>