...
<section class="near-main">
    <div class="container">
        ...
        <div class="bg-white box-shadow-lg rounded-lg overflow-hidden">
                ...
                <section class="col-lg-8 pt-2 pt-lg-4 pb-4 mb-3">
                  <div class="pt-2 px-4 pr-lg-0 pl-xl-5">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center border-bottom pb-3">
                      ...
                      <!-- <div class="py-1">
                          <a class="btn btn-outline-danger btn-sm" href="<?php echo e(url('/clear-cart')); ?>" onClick="return confirm('<?php echo e(Helper::translation(2892,$translate)); ?>');"><i class="dwg-close font-size-xs mr-1 ml-n1"></i>
                              <?php echo e(Helper::translation(4893,$translate)); ?> 
                          </a>
                      </div> -->
                    </div> 

                    <?php 
                  //  echo "<pre>";print_r($cart['item']);
                    ?>
                    <!-- Product-->
                    <?php 
                    $subtotal = 0;
                    ...
                    <div class="media d-sm-flex align-items-center py-4 border-bottom position-relative">
                      <div class="cart-prod-img mr-3 mb-sm-0 mr-sm-4">
                        <a class="d-block position-relative cart-img" href="<?php echo e(url('/procart')); ?>/<?php echo e(base64_encode($cart->ord_id)); ?>" onClick="return confirm('<?php echo e(Helper::translation(2892,$translate)); ?>');">
                        <?php if($itemArray[0]->item_thumbnail!=''): ?>
                        <img class="rounded-lg" src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($itemArray[0]->item_thumbnail); ?>" alt="<?php echo e($cart->item_name); ?>">
                        <?php else: ?>
                        <img src="<?php echo e(url('/')); ?>/public/img/no-image.png" alt="<?php echo e($cart->item_name); ?>" width="70" class="rounded-lg">
                        <?php endif; ?>
                        </a>
                        <a class="cart-remove-prod close-floating" href="<?php echo e(url('/procart')); ?>/<?php echo e(base64_encode($cart->ord_id)); ?>" onClick="return confirm('<?php echo e(Helper::translation(2892,$translate)); ?>');">
                          <span class="" title="<?php echo e(Helper::translation(5934,$translate)); ?>"><i class="dwg-close"></i></span>
                        </a>
                      </div>
                      <div class="media-body text-sm-left">
                        <h3 class="h6 product-title mb-2"><a href="<?php echo e(url('/item')); ?>/<?php echo e($itemArray[0]->item_slug); ?>"><?php echo e($cart->item_name); ?></a></h3>

                         <div class="d-inline-block text-accent quantity-selecter">
                            <div class="number-input text-accent">
                          
                            <span class="" min="0" name="quantity" id="quantity" ><?php echo e($cart->item_qunatity); ?></span>
                        ...
                        <div class="d-inline-block text-accent font-size-ms border-left ml-2 pl-2">
                                ...
                                <?php endif; ?>
                                <span <?php if($cart->discount_price != 0): ?> class="cross-line" <?php endif; ?>><?php echo e($allsettings->site_currency_symbol); ?> <?php echo e($cart->item_price); ?></span>
                        </div>

                       <!--  <a class="d-inline-block text-accent font-size-ms border-left ml-2 pl-2" href="<?php echo e(url('/item')); ?>/<?php echo e($cart->item_slug); ?>"><?php echo e($cart->license); ?><?php if($cart->license == 'regular'): ?> (<?php echo e(Helper::translation(2890,$translate)); ?>) <?php elseif($cart->license == 'extended'): ?> (<?php echo e(Helper::translation(2891,$translate)); ?>) <?php endif; ?>
                        </a> -->
                      </div>
                ...
                <aside class="col-lg-4">
                  ...
                  <div class="cz-sidebar-static h-100 ml-auto border-left">
                    <ul class="list-unstyled font-size-sm pt-3 pb-2 border-bottom">
                        ...
                        ?> 
                        <li class="d-flex justify-content-between align-items-center"><span class="mr-2"><?php echo e(Helper::translation(2895,$translate)); ?></span><span class="text-right">
                          <strong class="green">( <?php echo e($coupon_code); ?> )</strong>
                           <a href="<?php echo e(URL::to('/cart/')); ?>/remove/<?php echo e($coupon_code); ?>" class="red fs14" onClick="return confirm('<?php echo e(Helper::translation(2892,$translate)); ?>');" title="<?php echo e(Helper::translation(2889,$translate)); ?>"> <i class="dwg-close font-size-xs"></i> </a></span><?php echo e($allsettings->site_currency_symbol); ?> <?php echo e($coupon_discount); ?></span></li>
                        <?php else: ?>
                    ...
                    <a class="btn btn-primary btn-shadow btn-block mt-4" href="<?php echo e(url('/procheckout')); ?>"><i class="dwg-locked font-size-lg mr-2"></i>TEST<?php echo e(Helper::translation(2897,$translate)); ?></a>
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user/procart.blade.php ENDPATH**/ ?>