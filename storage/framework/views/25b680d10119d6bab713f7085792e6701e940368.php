        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(Helper::translation(2865,$translate)); ?></li>
              </li>
             </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(Helper::translation(2865,$translate)); ?></h1>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3 coupon">
            <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
              <h2 class="h3 pt-2 pb-4 mb-0 text-center text-sm-left border-bottom"><?php echo e(Helper::translation(2865,$translate)); ?></h2>
              <form action="<?php echo e(route('add-coupon')); ?>" class="needs-validation mt-3 pt-3" id="profile_form" method="post" enctype="multipart/form-data">
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/add-coupon.blade.php ENDPATH**/ ?>