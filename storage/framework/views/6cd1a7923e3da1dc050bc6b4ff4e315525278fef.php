...
<body>
    ...
    <?php if(in_array('items', $avilable)): ?>
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <form action="<?php echo e(route('admin.edit-newitems')); ?>" class="setting_form" id="item_form" method="post"
                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-9">
                            <div class="upld-item">
                                <div class="item_title">
                                    <input type="text" name="item_name" size="30" id="item_name" spellcheck="true"
                                        autocomplete="off" class="" placeholder="<?php echo e(trans('labels.itemname')); ?>"
                                        value="<?php echo e($edit['item']->item_name); ?>">
                                </div>
                                <div class="item_parmalink">
                                    <div class="item-edit-slug-box"><strong>Permalink:</strong>
                                        <a href="#" target="_blank" id="atagpro" onClick="pageRedirectionToslug('<?php echo e(@$edit['item']->item_slug); ?>')"> <?php echo e(URL::TO('/item/')); ?>/<span
                                                id="editable-post-name"><?php echo e(@$edit['item']->item_slug); ?></span></a>
                                            <input type="text" name="demo_url" id="demo_url" style="display:none;"
                                                value="<?php echo e(@$edit['item']->demo_url); ?>">
                                            ...
                                            <button type="button" class="item-edit-slug-btn" id="cacncelbtn"
                                                aria-label="Edit permalink"
                                                onClick="$('#editable-post-name').html('<?php echo e(@$edit['item']->item_slug); ?>');$(this).hide();$('#demo_url').hide();$('#okbtn').hide();$('#demo_url').val('<?php echo e(@$edit['item']->demo_url); ?>')"
                                        ...
                                        ‎<button type="button" class="item-edit-slug-btn" aria-label="Edit permalink"
                                                id="editbtn"
                                                onClick="$('#demo_url').show();$('#okbtn').show();$('#cacncelbtn').show();$('#demo_url').val($('#editable-post-name').html());$('#editable-post-name').html('');$(this).hide();">Edit
                                        </button>
                                        <!-- //demo_url -->
                                    </div>
                                </div>
                                <div class="upld-item-editor"> 
                                    <textarea name="item_desc" id="summary-ckeditor" rows="6" class="form-control"
                                        data-bvalidator="required"><?php echo e(html_entity_decode($edit['item']->item_desc)); ?></textarea>
                                </div>
                                <div class="upld-item-detail">
                                        ...
                                        <h2 class="hndle ui-sortable-handle">Product data
                                            <span class="type_box hidden"> —
                                                ...
                                                <label for="_virtual" class="show_if_simple tips" style="">
                                                    Virtual:
                                                    <input type="checkbox" name="virtual" id="virtual" value="1" <?php if($edit['item']->virtualp == 1): ?> checked="checked" <?php endif; ?>>
                                                </label>
                                                <label for="_downloadable" class="show_if_simple tips" style="">
                                                    Downloadable:
                                                    <input type="checkbox" name="downloadable" id="downloadable"
                                                        value="1" <?php if($edit['item']->downloadable == 1): ?> checked="checked" <?php endif; ?>>
                                                ...
                                                <label for="location">
                                                    ...
                                                    <select name="manufacturer" id="manufacturer"
                                                        ...
                                                        <?php $__currentLoopData = $manufacturer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manfact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($manfact->id); ?>" <?php if($edit['item']->manufacturers_id == $manfact->id): ?> selected="selected" <?php endif; ?>><?php echo e($manfact->name); ?></option>
                                    ...
                                    <div class="upld-item-tabs">
                                        <div class="row m-0">
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field _regular_price_field ">
                                                                ...
                                                                <input type="text" class="short wc_input_price" style=""
                                                                    ...
                                                                    value="<?php echo e(@$edit['item']->regular_price); ?>"
                                                                    placeholder="">
                                                            </p>
                                                            <p class="form-field _sale_price_field ">
                                                                <label for="_sale_price">Sale price ($)</label>
                                                                <input type="text" class="short wc_input_price" style=""
                                                                    name="extended_price" id="extended_price"
                                                                    value="<?php echo e(@$edit['item']->extended_price); ?>"
                                                                    placeholder="">
                                                            </p>
                                                        </div>
                                                            ...
                                                            <p class="form-field">
                                                                ...
                                                                <select name="hotels[]" id="hotel" class="short"
                                                                    ...
                                                                    <?php $__currentLoopData = $hotels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        ->where('id', $hotel->user_id)
                                                                        ->first(); ?>
                                                                        <option value="<?php echo e($hotel->item_id); ?>" <?php if(in_array($hotel->item_id, $itemhotel)): ?> selected="selected" <?php endif; ?>><?php echo e($hotel->item_name); ?>
                                            ...
                                            <?php $__currentLoopData = $manufacturer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manfact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               <option value="<?php echo e($manfact->manufacturers_id); ?>" <?php if(in_array($manfact->manufacturers_id, $item_manfact)): ?> selected="selected" <?php endif; ?> ><?php echo e($manfact->manufacturers_name); ?></option>
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="tab-pane fade" id="inventory" role="tabpanel"
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field">
                                                                <label for="_sku"><abbr
                                                                        title="Stock Keeping Unit">SKU</abbr></label>
                                                                <input type="text" class="short" id="sku" name="sku"
                                                                    value="<?php echo e(@$edit['item']->sku); ?>">
                                                            </p>
                                                            <p class="form-field">
                                                                <label for="_manage_stock">Manage stock?</label>
                                                                <input type="checkbox" class="checkbox" id="instdock"
                                                                    name="instockf" value="yes"
                                                                    onClick="hidedivs(this)"> <span
                                                                    class="description">Enable stock management at
                                                                    product level</span>
                                                            </p>
                                                            ...
                                                            <div class="stock_fields" id="stock_fields">
                                                                <p class="form-field _stock_field ">
                                                                    ...
                                                                    <input type="number" class="short wc_input_stock"
                                                                        ...
                                                                        value="<?php echo e(@$edit['item']->stock_quantity); ?>">
                                                                </p>
                                                                <p class="form-field">
                                                                    <label for="backorders">Allow backorders?</label>
                                                                    <select id="backorders" name="backorders"
                                                                        class="select short">
                                                                        <option value="0" <?php if(@$edit['item']->backorders == 0): ?> selected="selected" <?php endif; ?>>Do not
                                                                            allow</option>
                                                                        <option value="1" <?php if(@$edit['item']->backorders == 1): ?> selected="selected" <?php endif; ?>>Allow, but notify
                                                                            customer</option>
                                                                        <option value="2" <?php if(@$edit['item']->backorders == 2): ?> selected="selected" <?php endif; ?>>Allow</option>
                                                                    </select>
                                                                </p>
                                                                <p class="form-field ">
                                                                    <label for="low_stock_amount">Low stock
                                                                        threshold</label>
                                                                    <input type="number" class="short"
                                                                        name="low_stock_amount" id="low_stock_amount"
                                                                        placeholder="2" value="<?php echo e(@$edit['item']->low_stock_amount); ?>">
                                                                </p>
                                                            </div>
                                                            <p class="form-field">
                                                                    ...
                                                                    <select id="instock" name="instock"
                                                                        class="select short">
                                                                        <option value="0" <?php if(@$edit['item']->instock == 0): ?> selected="selected" <?php endif; ?>>Out of stock</option>
                                                                        <option value="1" <?php if(@$edit['item']->instock == 1): ?> selected="selected" <?php endif; ?>>In stock</option>
                                                                        <option value="2" <?php if(@$edit['item']->instock == 2): ?> selected="selected" <?php endif; ?>>On backorder</option>
                                                                    </select>
                                                            </p>
                                                        </div>
                                                        <div class="options_group">
                                                            <p class="form-field">
                                                                ...
                                                                <input type="checkbox" class="checkbox"
                                                                    ...
                                                                    value="1" <?php if(@$edit['item']->sold_individually == 1): ?> checked='checked' <?php endif; ?>>
                                                        ...
                                                        <div class="options_group">
                                                            <p class="form-field _weight_field ">
                                                                ...
                                                                <input type="text" class="short wc_input_decimal"
                                                                    ...
                                                                    value="<?php echo e(@$edit['item']->weight); ?>"
                                                                    placeholder="0">
                                                            </p>
                                                            <p class="form-field">
                                ...
                                <div class="upld-item-detail">
                                    ...
                                    <div class="upld-item-detail-body">
                                        ...
                                        <textarea id="editor2" class="ckeditor" name="item_shortdesc"
                                            data-bvalidator="required"><?php echo e(html_entity_decode($edit['item']->item_shortdesc)); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-3">
                            <div class="upld-item-detail">
                                ...
                                <div id="post-status-select" class="">
                                    <select name="item_status" class="select-custome" id="item_status">
                                        <option  value="1" <?php if(@edit['item']->item_status == '1'): ?> selected="selected" <?php endif; ?>>Yes</option>
                                        <option value="0" <?php if(@edit['item']->item_status == '0'): ?> selected="selected" <?php endif; ?>>no</option>
                                      
                                    </select>
                                    <a href="#" class="button-custome">OK</a>
                                    ...
                                    <div class="misc-pub-section misc-pub-post-status">
                                        Status: <span id="post-status-display">
                                            <?php if(@$edit['item']->item_status == 1): ?>
                                            Published <?php else: ?> UnPublished <?php endif; ?>
                                        </span>
                                        ...
                                        <div id="post-status-select" class="" style="display:none;">
                                            <select name="item_status" id="item_status" class="select-custome">
                                                <option value="Published" <?php if(@$edit['item']->item_status == 1): ?> selected="selected" <?php endif; ?>>Yes
                                                </option>
                                                <option value="UnPublished" <?php if(@$edit['item']->item_status == 0): ?> selected="selected" <?php endif; ?>>no
                                                </option>
                                            </select>
                                    ...
                                    <div class="misc-pub-section misc-pub-visibility" id="visibility">
                                        Visibility: 
                                        <span id="post-visibility-display"><?php if(@$edit['item']->drop_status == 'yes'): ?> No <?php endif; ?> <?php if(@$edit['item']->drop_status == 'no'): ?> Yes <?php endif; ?> </span>
                                        ...
                                        <div id="post-visibility-select" class="" style="display:none;">
                                            <input type="radio" name="drop_status" id="drop_status" value="no"
                                                 <?php if(@$edit['item']->drop_status == 'yes'): ?> checked="checked" <?php endif; ?>> 
                                                <label for="visibility-radio-public" class="selectit">No</label>
                                            <br>
                                                <input type="radio" name="drop_status" id="drop_status" value="yes" <?php if(@$edit['item']->drop_status == 'no'): ?> checked="checked" <?php endif; ?>>Yes
                                            <br>
                                            <p>
                                                <a href="#visibility" class="button-custome" onClick="shoowDropstatusButton(1)">OK</a>
                                                <a href="#visibility" class="button-link" onClick="shoowDropstatusButton(0)">Cancel</a>
                                            </p>
                                        </div>
                                    </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><input type="checkbox" name="subcategory[]"
                                                                    id="subcategory" value="<?php echo e($value1->subcat_id); ?>"
                                                                    <?php if(in_array($value1->subcat_id, $selcategoriesarray)): ?> checked="checked" <?php endif; ?> /> -
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><input type="checkbox" name="subcategory[]"
                                                                            id="subcategory"
                                                                            value="<?php echo e($subsubvalue->subcat_id); ?>" <?php if(in_array($subsubvalue->subcat_id, $selcategoriesarray)): ?> checked="checked" <?php endif; ?> /> --
                                    ...
                                    <div class="add-tags-main">
                                        <div class="add-tags">
                                        	<form method="post" enctype="multipart/form-data">
	                                            ...
	                                            <input type="text" class="text-form-custome" name="item_tags" id="item_tags"
	                                                value="<?php echo e($edit['item']->item_tags); ?>">
 ...
 -->
                                            ...
                                            <?php if(in_array($value->tag_id,@$seltagarray)): ?>  

                                                                <button type="button" id="product_tag-check-num-1" class="ntdelbutton" onClick="removeTagItem('<?php echo $value->tag_id; ?>','fa fa-times-circle','<?php echo $value->tag_name; ?>','fa fa-check')">
  											...
  											<i class="fa fa-times-circle" aria-hidden="true"></i> <?php endif; ?>
                                                                </button>&nbsp;<?php echo e($value->tag_name); ?> 

                                                <?php if(in_array($value->tag_id,@$seltagarray)): ?>  <input type="hidden" name="tag_id[]" id="tagstags" value="<?php echo e($value->tag_id); ?>" /> <?php endif; ?>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                             <?php endif; ?>
                            ...
                            <div class="upld-item-detail">
                                <div class="upld-item-detail-head">
                                    <h2 class="hndle ui-sortable-handle">Product image</h2>
                                </div>
                                <div class="upld-item-detail-body">
                                    <div class="item-img-upload">
                                        ...
                                        <?php if($edit['item']->item_preview != ''): ?>
                                            <img src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($edit['item']->item_preview); ?>"
                                                alt="<?php echo e($edit['item']->item_name); ?>" class="item-thumb">
                                        <?php else: ?>
                                    ...
                                    <input type="hidden" name="item_id" value="<?php echo e($edit['item']->pro_id); ?>">
                                    <input type="hidden" name="item_token" value="<?php echo e($edit['item']->item_token); ?>">
                                    <input type="hidden" name="save_preview"
                                        value="<?php echo e($edit['item']->item_preview); ?>">
                            ...
                            <div class="upld-item-detail">
                                <div class="upld-item-detail-head">
                                    <h2 class="hndle ui-sortable-handle">Product Screenshot</h2>
                                </div>
                                <div class="upld-item-detail-body">
                                    <div class="item-img-upload">
                                        <!--  <a href="#" class="thickbox"> -->
                                        <!-- <img src="https://analyticsindiamag.com/wp-content/uploads/2018/12/image.jpg" alt=""> -->
                                        <input type="file" id="item_screenshot" name="item_screenshot[]"
                                            class="files"><small>(<?php echo e(Helper::translation(2946, $translate)); ?> :
                                            750x430px)</small><br /><br />
                                        ...
                                        <?php $__currentLoopData = $item_image['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="item-img"><img
                                                    src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($item->item_image); ?>"
                                                    alt="<?php echo e($item->item_image); ?>" class="item-thumb">
                                                <a href="<?php echo e(url('/admin/edit-product')); ?>/dropimg/<?php echo e(base64_encode($item->itm_id)); ?>"
                                                    onClick="return confirm('<?php echo e(Helper::translation(5064, $translate)); ?>?');"
                                                    class="drop-icon"><span class="ti-trash drop-icon"></span></a>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function pageRedirectionToslug(url){
            
           // var demourlval=$('#demo_url').val();
            var demourlval=url;
         
          //alert(demourlval);
          // alert(demourlval);
          //  var url="<?php echo e(URL::TO('/item/')); ?>/"+demourlval;
         //  var demourlval1=demourlval.replace('','-');
            // var url="<?php echo e(URL::TO('/item/')); ?>/"+demourlval1;

            var demourlval1=demourlval.split(' ').join('-');

            // console.log(demourlval1);
            window.location.href="<?php echo e(URL::TO('/item/')); ?>/"+demourlval1;
        ...
        var itemhotel = "<?php echo e(implode(',', $itemhotel)); ?>";
        var itemroom = "<?php echo e(implode(',', $itemroom)); ?>";
        fetchvendor(itemhotel, itemroom);
       ...
       function removeTagItem(tagid,clsname,tagname,addclsname){
        ...
        $("#hotel").change(function() {
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    //  user_id: vendorid,
                    //sel_hotel:"<?php echo e(implode(',', $itemhotel)); ?>",
                    sel_room: test,
                    sel_hotel: $(this).val(),
        ...
        function fetchvendor(itemhotel, itemroom) {

            var test = itemhotel.split(",");
            var itemroom = itemroom.split(",");
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/product/edit-item.blade.php ENDPATH**/ ?>