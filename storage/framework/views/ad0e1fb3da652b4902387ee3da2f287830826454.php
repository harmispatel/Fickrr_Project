                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="hidden" name="user_type" value="admin">
                                               <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="socialmedialinks" class="control-label mb-1"><?php echo e(trans('labels.socialmedialinksfacebook')); ?> <span class="require">*</span></label>
                                                    <input name="socialmedialinks" id="socialmedialinks" type="text"  class="form-control"  data-bvalidator="url" required value="<?php echo e(@$edit['userdata']->facebook_url); ?>">
                                                ...
                                                <div class="form-group">
                                                    <label for="instagram" class="control-label mb-1"><?php echo e(trans('labels.instagram')); ?><span class="require">*</span></label>
                                                    <input name="instagram" id="instagram" type="text"  class="form-control"  data-bvalidator="url" required value="<?php echo e(@$edit['userdata']->instagram); ?>"/>
                                                
                                                </div>
    
                                                 <div class="form-group">
                                                    <label for="linkedin" class="control-label mb-1"><?php echo e(trans('labels.twitterurl')); ?><span class="require">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="youtube" class="control-label mb-1"><?php echo e(trans('labels.youtube')); ?><span class="require">*</span></label>
                                                    <input name="youtube" id="youtube" type="text"  class="form-control"  data-bvalidator="url" required value="<?php echo e(@$edit['userdata']->youtube); ?>"/>
