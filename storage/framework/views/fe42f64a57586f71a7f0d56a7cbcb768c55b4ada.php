<aside id="left-panel" class="left-panel">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <!-- <li class="menu-item-has-children dropdown dropdown-submenu"><a href="#" class="dropdown-toggle"><i class="fa fa-gear"></i> test</a>
                                <ul class="sub-menu children dropdown-menu">
                                    <li><i class="fa fa-gear"></i><a href="<?php echo e(url('/admin/general-settings')); ?>">test1</a></li>
                                    <li><i class="fa fa-gear"></i><a href="<?php echo e(url('/admin/color-settings')); ?>">test1</a></li>
                                </ul>
                            </li> -->
                   ...
                   <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user"></i><a href="<?php echo e(url('/admin/administrator')); ?>">Administrator</a></li>
                            ...
                            <li><i class="fa fa-user"></i><a href="<?php echo e(url('/admin/manufacturers')); ?>">Manufacturer</a></li>
                         </ul>
                    </li>
                    <?php endif; ?>                   
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/items')); ?>"><?php echo e(trans('labels.VendorStore')); ?></a></li>
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/item-type')); ?>"><?php echo e(trans('labels.roomtype')); ?></a></li>
                            <!-- <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/shopItems')); ?>"><?php echo e(Helper::translation(5442,$translate)); ?></a></li> -->
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/designers')); ?>"><?php echo e(trans('labels.designers')); ?></a></li>
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/orders')); ?>"><?php echo e(Helper::translation(5619,$translate)); ?></a></li>
                             <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/upload-newitems')); ?>">Products</a></li>
                             <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/tag')); ?>"><?php echo e(trans('labels.tag')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
    ...
    </aside><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/navigation.blade.php ENDPATH**/ ?>