                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                        <form action="<?php echo e(route('admin.upload-shopitem')); ?>" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/upload-shopitem.blade.php ENDPATH**/ ?>