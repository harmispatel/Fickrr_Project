<?php if(!empty($shareItemDetail)): ?> 
  <?php $__env->startSection('metashare'); ?>
	<meta property="og:url"           content="<?php echo e($shareItemDetail['url']); ?>" />
	<meta property="og:type"          content="website" />
	<meta property="og:title"         content="<?php echo e($shareItemDetail['title']); ?>" />
	<meta property="og:description"   content="<?php echo e($shareItemDetail['title']); ?>" />
	<meta property="og:image"         content="<?php echo e($shareItemDetail['image']); ?>" />
...
<section class="product-details-sec">
 ...
 -->
					 <div class="cz-gallery preview-pic tab-content">
						 ...
						 <div class="item">
						  ...
						  <?php if($image->item_image!=''): ?>
							<img src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($image->item_image); ?>" alt="<?php echo e($item['item']->item_name); ?>">
						  <?php else: ?>
							<img src="<?php echo e(url('/')); ?>/public/img/no-image.png" alt="<?php echo e($item['item']->item_name); ?>">
						  <?php endif; ?>
					...
					?>
						...
						<?php if(count($item_allimage) > 0): ?>
						 <div class="cz-gallery" lg-uid="lg0">
							<div id="thumbs-images" class="owl-carousel">
								 <?php $__currentLoopData = $item_allimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							
									<div class="item">
											<a class="gallery-item rounded-lg mb-grid-gutter thumber" href="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($image->item_image); ?>" data-sub-html="<?php echo e($item['item']->item_name); ?>">
												<img src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($image->item_image); ?>" alt="<?php echo e($image->item_image); ?>" class="single-thumbnail"/>
												<span class="gallery-item-caption"><?php echo e($item['item']->item_name); ?></span>
											</a>
									</div>
				...
				<div class="details col-md-6">
					<h3 class="product-title"><?php echo e($item['item']->item_name); ?></h3>
					<div class="product-owner">
					  See More by <a href="#"><?php echo e($item['item']->username); ?></a>
					</div>
					<div class="rating">
						<div class="stars">
					...
					<h4 class="price">$<?php echo e($item['item']->regular_price); ?><del>$<?php echo e($item['item']->extended_price); ?></del></h4>
						...
						<div class="d-block">
						  ...
						  <?php if(count($hotel) > 0): ?>
						  	...
						  	<div class="vendorstoreselection">
						  		...
						  		<input type="radio" name="hotel" id="hotel" value="<?php echo e($value->hotel_id); ?>" checked="checked"><a href="shopstore/<?php echo e($item_name->item_slug); ?>"> <?php echo e($item_name->item_name); ?> </a>
						  </div>
						  	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						  <?php endif; ?>
					...
					<div class="product-action mb-2">
					  ...
					  <div class="cart-wish w-100">
						 <form action="<?php echo e(route('procart')); ?>" class="setting_form" method="post" id="order_form" enctype="multipart/form-data">
						  <div class="d-flex w-100 add-crt-respo">
							 <?php echo e(csrf_field()); ?> 

							 <?php if(Auth::guest()): ?>
									<button class="like" type="button" onClick="window.location.href='<?php echo e(URL::to('/login')); ?>'"><i class="ti ti-heart"></i></button>
							<?php endif; ?>
				  <?php if(Auth::check()): ?>
				  <?php if($item['item']->user_id != Auth::user()->id): ?>
				   <!--  <a class="btn btn-outline-accent btn-sm" href="<?php echo e(url('/item')); ?>/<?php echo e(base64_encode($item['item']->pro_id)); ?>/favorite/<?php echo e(base64_encode($item['item']->item_liked)); ?>">
				  ...
				  <?php endif; ?>
						...
						<?php if(Auth::guest()): ?>
							 <a class="btn btn-primary btn-shadow btn-block" href="<?php echo e(URL::to('/login')); ?>"> <i class="dwg-cart font-size-lg mr-2"></i><?php echo e(Helper::translation(3074,$translate)); ?> </a>
						<?php endif; ?>
					   ...
					   <?php 
						...
						@else */ ?>
								...
								<input type="hidden" name="item_id" value="<?php echo e($item['item']->pro_id); ?>">
								...
								<input type="hidden" name="item_price" value="<?php echo e($item['item']->regular_price); ?>">
								<input type="hidden" name="item_token" value="<?php echo e($item['item']->item_token); ?>">
								<?php if($checkif_purchased == 0): ?>

										<?php if(Auth::user()->id != 1): ?>
											<!-- <button type="submit" class="btn btn-primary btn-shadow btn-block"><i class="dwg-cart font-size-lg mr-2"></i><?php echo e(Helper::translation(3074,$translate)); ?></button> -->
												 <button type="button" class="btn btn-primary btn-shadow btn-block" onClick="checkhotelselection();"><i class="dwg-cart font-size-lg mr-2"></i><?php echo e(Helper::translation(3074,$translate)); ?>
						...
						<div id="collapseOne" class="collapse show" style="">
						  <div class="card-body">
							<div class="card-desc-accordion collapse" id="collapseExample" aria-expanded="false">
							  <p><?php echo html_entity_decode($item['item']->item_desc); ?></p> 
							</div>
							<div class="showmore">
						...
						<div id="collapseTwo" class="collapse" style="">
						  <div class="card-body">
							<table class="table">
							  <tr>
								<td>Overall</td>
								<td><?php echo e($item['item']->width); ?>'' W * <?php echo e($item['item']->length); ?> '' L</td>
							  </tr>
							  <tr>
								<td>Capacity</td>
								<td><?php echo e($item['item']->weight); ?> - <?php echo e($item['item']->height); ?> </td>
							  </tr>
							</table>
						  </div>
						</div>
					  ...
					  <div class="card">
						...
						<div id="collapseThree" class="collapse" style="">
						  <div class="card-body">
							...
							<p><?php echo e($item['item']->about); ?></p>
						  </div>
						</div>
					  </div>
					</div>
		...
		<div class="col-md-3">
		  <figure class="card card-product">
			  ...
			  <figcaption class="info-wrap">
				<a href="<?php echo e(URL::to('/item')); ?>/<?php echo e($p->item_slug); ?>">
				  <h4 class="title"><?php echo e($p->item_name); ?></h4>
				  <p class="oener-prod">by <?php echo e($p->username); ?></p>
				</a>
				<div class="rating-wrap">
				  <div class="rating">
					<div class="stars">
					  <?php $ratnum = 0; ?>
					  <?php if(count($p->ratings) >0): ?>
						<?php $__currentLoopData = $p->ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						  <span class="ti ti-star"></span>
						  <?php $ratnum++; ?>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					  <?php endif; ?>
					</div>
					<span class="rating-review"><?php echo e($ratnum); ?></span>
			  ...
			  <div class="bottom-wrap">
				  <div class="price-wrap h5">
					  <span class="price-new">$<?php echo e($p->regular_price); ?></span> <del class="price-old">$<?php echo e($p->extended_price); ?></del>
				  </div> <!-- price-wrap.// -->
  ...
  <script>
    ...
    //  alert("Hello");
      $(document).ready(function(){
        var shareType = "<?php echo e($shareItemDetail['shareType']); ?>";
        var url = "<?php echo e($shareItemDetail['url']); ?>";
        if(shareType == 'facebook'){
          ...
          var currentTitle="<?php echo e($shareItemDetail['title']); ?>";
          ...
          var title = "<?php echo e($shareItemDetail['title']); ?>";
          // var description = '';
...
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user/productitem.blade.php ENDPATH**/ ?>