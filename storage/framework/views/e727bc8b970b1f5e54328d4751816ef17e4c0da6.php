            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(trans('labels.addManufacturer')); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-manufacturers')); ?>" class="setting_form" id="item_form" method="post" enctype="multipart/form-data"> 
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(trans('labels.addManufacturer')); ?> <span class="require">*</span></label>
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/add-manufacturers.blade.php ENDPATH**/ ?>