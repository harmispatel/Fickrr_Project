    ...
    <div class="container pb-5">
      <div class="row pt-5 mt-md-2">
        <section class="col-lg-8">
          ...
          <h5><?php echo e(Helper::translation(6087,$translate)); ?> <a href="<?php echo e(URL::to('/login')); ?>"><?php echo e(Helper::translation(6090,$translate)); ?></a> <?php echo e(Helper::translation(6093,$translate)); ?></h5>
          </div>
          <?php endif; ?>
          <?php if(Auth::check()): ?>
          <div class="pt-2 mt-5" id="comments">
