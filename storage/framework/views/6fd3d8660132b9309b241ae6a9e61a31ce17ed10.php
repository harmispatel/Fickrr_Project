                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.edit-vendor')); ?>" method="post" class="setting_form" id="item_form" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                               ...
                                               <!--  <div class="form-group">
                                                    ...
                                                    <input id="address" name="address" type="text" class="form-control" required value="<?php echo e($edit['userdata']->address); ?>">
                                                </div> -->

                                                <div class="form-group">
                                                    <label for="phonenumber" class="control-label mb-1"><?php echo e(trans('labels.phonenumber')); ?>  <span class="require">*</span></label>
                                                    <input id="phonenumber" name="phonenumber" type="text" class="form-control" required value="<?php echo e($edit['userdata']->phonenumber); ?>">
                                                </div>

                                                <div class="form-group">
                                                        <label for="about" class="control-label mb-1"><?php echo e(trans('labels.about')); ?> <span class="require">*</span></label>
                                                        <textarea id="about" name="about" class="form-control" ><?php echo e($edit['userdata']->about); ?></textarea>
                                                </div>

                                                   <div class="form-group">
                                                <label for="socialmedialinks" class="control-label mb-1"><?php echo e(trans('labels.socialmedialinksfacebook')); ?></label>
                                                <input name="socialmedialinks" id="socialmedialinks" type="text"  class="form-control" value="<?php echo e(@$edit['userdata']->facebook_url); ?>" data-bvalidator="url" required/>
                                            
                                            </div>

                                            <div class="form-group">
                                                <label for="instagram" class="control-label mb-1"><?php echo e(trans('labels.instagram')); ?></span></label>
                                                <input name="instagram" id="instagram" type="text"  class="form-control" value="<?php echo e(@$edit['userdata']->instagram); ?>" data-bvalidator="url" required/>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input name="twitterurl" id="twitterurl" type="text"  class="form-control"  data-bvalidator="url" required value="<?php echo e(@$edit['userdata']->twitter_url); ?>"/>
                                            
                                            </div>
                                            <div class="form-group">
                                                <label for="youtube" class="control-label mb-1"><?php echo e(trans('labels.youtube')); ?></label>
                                                <input name="youtube" id="youtube" type="text"  class="form-control" value="<?php echo e(@$edit['userdata']->youtube); ?>" data-bvalidator="url" required/>
                                               ...
                                               <!--   <div class="form-group">
                                                ...
                                                ?>
                                                 ...
                                                 <select name="item_shop[]" id="item_shop" class="form-control chosen-select" multiple="multiple">
                                                    ...
                                                    <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($value->item_id); ?>" <?php if(in_array($value->item_id,$selectedshop)): ?> selected='selected' <?php endif; ?>><?php echo e($value->item_type); ?>-<?php echo e($value->item_name); ?></option>
                                                ...
                                                <input type="hidden" name="user_id" value="<?php echo e($edit['userdata']->id); ?>">
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/edit-vendor.blade.php ENDPATH**/ ?>