...
<html lang="en">
<head>
<title><?php echo e(Helper::translation(3027,$translate)); ?> - <?php echo e($allsettings->site_title); ?></title>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page"><?php echo e(Helper::translation(3027,$translate)); ?></li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white"><?php echo e(Helper::translation(3027,$translate)); ?></h1>
        </div>
      </div>
      </div>
    </section>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/featured-items.blade.php ENDPATH**/ ?>