            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(5457,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                   <!--  <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/products-import-export/xlsx')); ?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i>Hotel <?php echo e(Helper::translation(5799,$translate)); ?></a>&nbsp;
                         </ol>
                    </div> -->

                     <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/productss-import-export/xlsx')); ?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i><?php echo e(Helper::translation(5799,$translate)); ?></a>&nbsp;
                         </ol>
                    </div>
                </div>
            </div>
