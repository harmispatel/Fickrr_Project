                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php $__currentLoopData = $categoryData['category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category->cat_id); ?>" class="selctedcls" <?php if($edit['subcategory']->cat_id == $category->cat_id): ?>  selected="selected" <?php endif; ?>><?php echo e($category->category_name); ?></option>
                                                      ...
                                                      <?php 
                                                                ...
                                                                if( count ($value) > 0 ){
                                                                    foreach($value as $key=>$value1){ ?>
                                                                        ...
                                                                        <option value="<?php echo e($value1->subcat_id); ?>_<?php echo e($category->cat_id); ?>" <?php if($value1->subcat_id == $edit['subcategory']->subcatparent_id): ?>  selected="selected" <?php endif; ?>> - <?php echo e($value1->subcategory_name); ?></option>
