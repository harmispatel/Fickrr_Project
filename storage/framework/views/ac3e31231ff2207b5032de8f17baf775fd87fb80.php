                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Features <span class="require">*</span></label>
                                                                                                
                                                <select name="site_features_display" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->site_features_display == 1): ?> selected <?php endif; ?>>Enable</option>
                                                <option value="0" <?php if($setting['setting']->site_features_display == 0): ?> selected <?php endif; ?>>Disable</option>
                                                </select>
                                            </div>
                                       </div>
                                </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">Start Selling <span class="require">*</span></label>
                                                                                                
                                                <select name="site_selling_display" class="form-control" data-bvalidator="required">
                                                <option value=""></option>
                                                <option value="1" <?php if($setting['setting']->site_selling_display == 1): ?> selected <?php endif; ?>>Enable</option>
                                                <option value="0" <?php if($setting['setting']->site_selling_display == 0): ?> selected <?php endif; ?>>Disable</option>
                                                </select>
                                            </div>
