                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.edit-shopitem')); ?>" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                          ...
                                          <?php endif; ?>
                                            ...
                                            <div class="form-group" id="afteradd">
                                                ...
                                                <input type="text" name="location" id="autocomplete" onFocus="geolocate()"  placeholder="Location" data-parsley-required="true"  value="<?php echo e($edit['item']->address); ?>" class="form-control" >
       ...
       function fetchRoomCategory(vendorid){
         ...
         jQuery.ajax({
                ...
                data: {
                    ...
                    sel_room:"<?php echo e(implode(',',$itemroom)); ?>",
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/edit-shopitem.blade.php ENDPATH**/ ?>