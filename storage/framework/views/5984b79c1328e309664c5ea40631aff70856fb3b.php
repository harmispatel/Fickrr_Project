...
<section class="bg-position-center-top" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e(explode(',',$allsettings->site_banner)[0]); ?>');">
      <div class="py-4">
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">REST REST REST REST DEVANSHI DE<?php echo e(Helper::translation(3178,$translate)); ?></li>
            </ol>
          </nav>
        </div>
          ...
          <div class="card product-card-alt">
            <div class="product-thumb">
              ...
              <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow font-size-base mx-2" href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>"><i class="dwg-eye"></i></a>
                <a class="btn btn-light btn-icon btn-shadow font-size-base mx-2" href="<?php echo e(URL::to('/item')); ?>/<?php echo e($featured->item_slug); ?>"><i class="dwg-cart"></i>testtest</a>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/shop.blade.php ENDPATH**/ ?>