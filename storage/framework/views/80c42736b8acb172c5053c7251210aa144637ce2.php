        ...
        <div class="row">
                  ...
                  <?php $__currentLoopData = $item_allimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-2">
                        <a class="gallery-item rounded-lg mb-grid-gutter thumber" href="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($image->item_image); ?>" data-sub-html="<?php echo e($item['item']->item_name); ?>">
                            <img src="<?php echo e(url('/')); ?>/public/storage/items/<?php echo e($image->item_image); ?>" alt="<?php echo e($image->item_image); ?>"/>
                            <span class="gallery-item-caption"><?php echo e($item['item']->item_name); ?></span>
                        </a>
                    </div>
          ...
          <aside class="col-lg-4">
            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
              ...
              <div class="bg-secondary rounded p-3 mb-4"><i class="dwg-chat h5 text-muted align-middle mb-0 mt-n1 mr-2"></i><span class="d-inline-block h6 mb-0 mr-1"><?php echo e($comment_count); ?></span><span class="font-size-sm"><?php echo e(Helper::translation(3054,$translate)); ?></span></div>
              <ul class="list-unstyled font-size-sm">
          ...
          <div class="card product-card-alt">
            ...
            <div class="card-body">
              ...
              <a class="blog-entry-meta-link" href="<?php echo e(URL::to('/user')); ?>/<?php echo e($featured->username); ?>">
                    ...
                    <?php endif; ?>
                    </div><?php echo e($featured->username); ?></a>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/item.blade.php ENDPATH**/ ?>