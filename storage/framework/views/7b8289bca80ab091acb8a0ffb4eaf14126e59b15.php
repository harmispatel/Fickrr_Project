						...
						<div class="col pull-right">
						 ...
						 <a href="<?php echo e(url('/manage-item')); ?>" class="btn btn-primary btn-sm dropbtn" > <?php echo e(trans('labels.OwnSHops')); ?></a> 
							...
							<div class="row pt-2 mx-n2"> 
									...
									?>
									<div class="col-md-6 col-lg-4 mb-4  prod-item">
...
<!---->
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user/manage-item.blade.php ENDPATH**/ ?>