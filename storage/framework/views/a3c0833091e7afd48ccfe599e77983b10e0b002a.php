            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(4953,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <!--   <?php if(Auth::user()->id == 1): ?>
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(2944,$translate)); ?>"></div>
                                    </div>
                                </div>
                              </div>
                            </div>
...
</html><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/add-administrator.blade.php ENDPATH**/ ?>