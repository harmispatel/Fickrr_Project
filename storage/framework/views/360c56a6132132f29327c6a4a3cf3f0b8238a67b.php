                        ...
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/products-import-export')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o"></i> <?php echo e(Helper::translation(5457,$translate)); ?></a>&nbsp;
                               ...
                               <?php $encrypted = $encrypter->encrypt('product'); ?>
                                <a href="<?php echo e(URL::to('/admin/upload-shopItems')); ?>/<?php echo e($encrypted); ?>" class="btn btn-success btn-sm dropbtn"><i class="fa fa-plus"></i><?php echo e(trans('labels.addItem')); ?></a>
                                    ...
                                    <?php $__currentLoopData = $itemData['item']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                   ...
                                                   <a href="items/<?php echo e($item->item_stafffav); ?>/<?php echo e($item->item_token); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;"> 
                                                    <input type="checkbox" name="item_stafffav" id="item_stafffav" value="<?php echo e($item->item_stafffav); ?>" /> 
                                                   </a>
                                                 <?php else: ?> 
                                                        <a href="items/<?php echo e($item->item_stafffav); ?>/<?php echo e($item->item_token); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;">  <input type="checkbox" name="item_stafffav" id="item_stafffav" value="<?php echo e($item->item_stafffav); ?>" checked="checked" /> 
                                                        </a>
                                                 <?php endif; ?> 
                                            ...
                                            <?php if($item->tiem_ravybeexc == 1): ?>
                                                   <a href="itemsr/<?php echo e($item->tiem_ravybeexc); ?>/<?php echo e($item->item_token); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;"> 
                                                    <input type="checkbox" name="tiem_ravybeexc" id="tiem_ravybeexc" value="<?php echo e($item->tiem_ravybeexc); ?>" checked="checked"/> 
                                                   </a>
                                            <?php else: ?> 
                                                        <a href="itemsr/<?php echo e($item->tiem_ravybeexc); ?>/<?php echo e($item->item_token); ?>" style="font-size:12px; color:#0000FF; text-decoration:underline;">    <input type="checkbox" name="tiem_ravybeexc" id="tiem_ravybeexc" value="<?php echo e($item->tiem_ravybeexc); ?>" /> 
                                                        </a>
                                           <?php endif; ?> 
                                           ...
                                           <!--  <td><?php if($item->free_download == 1): ?> <span class="badge badge-success"><?php echo e(Helper::translation(2970,$translate)); ?></span> <?php else: ?> <span class="badge badge-danger"><?php echo e(Helper::translation(2971,$translate)); ?></span> <?php endif; ?></td> -->
                                            ...
                                            <td><a href="edit-shopItems/<?php echo e($item->item_token); ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; <?php echo e(Helper::translation(2923,$translate)); ?></a> 
                                            <?php if($demo_mode == 'on'): ?> 
                                            <a href="demo-mode" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i>&nbsp;<?php echo e(Helper::translation(2924,$translate)); ?></a>
                                            <?php else: ?>
                                            <a href="shopItems/<?php echo e($item->item_token); ?>" class="btn btn-danger btn-sm" onClick="return confirm('<?php echo e(Helper::translation(5064,$translate)); ?>?');"><i class="fa fa-trash"></i>&nbsp;<?php echo e(Helper::translation(2924,$translate)); ?></a><?php endif; ?></td>
                                        </tr>
                                        <?php $no++; ?>
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/shop/shopitems.blade.php ENDPATH**/ ?>