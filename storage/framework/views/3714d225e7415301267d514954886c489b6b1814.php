    ...
    <script src="<?php echo e(URL::to('resources/views/admin/template/vendors/ckeditor5/ckeditor.js')); ?>"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
		  $(".add-new-cat > a.add-new-cat-link").click(function(){
		    $(".add-new-cat").toggleClass("have-child");
		  });
		});
		$(document).ready(function(){
		  $(".add-tags-main .most-use-tag").click(function(){
		    $(".most-use-tag").toggleClass("have-child");
		  });
		});
        (jQuery);
	</script>
...
</script><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/javascript.blade.php ENDPATH**/ ?>