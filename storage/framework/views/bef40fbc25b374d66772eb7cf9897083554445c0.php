            ...
            <!--   <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="instagram" name="instagram" class="form-control" data-bvalidator="required,maxlen[100]" value="<?php echo e($edit['item']->instagram); ?>">
                </div>
              </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="linkedin" name="linkedin" class="form-control" data-bvalidator="required,maxlen[100]" value="<?php echo e($edit['item']->linkedin); ?>">
                    </div>
              </div>
              <div class="col-sm-6">
                    <div class="form-group">
                      <label for="account-fn"><?php echo e(trans('labels.website')); ?> <span class="require">*</span></label>
                      <input type="text" id="website" name="website" class="form-control" data-bvalidator="required,maxlen[100]" value="<?php echo e($edit['item']->website); ?>">
                    </div>
              </div>
              <div class="col-sm-6">
                    <div class="form-group">
                      <label for="account-fn"><?php echo e(trans('labels.phonenumber')); ?> <span class="require">*</span></label>
                      <input type="text" id="phonenumber" name="phonenumber" class="form-control" data-bvalidator="required,maxlen[100]" value="<?php echo e($edit['item']->phonenumber); ?>">
                    </div>
              </div>
              <div class="col-sm-6">
                    <div class="form-group">
                      <label for="account-fn"><?php echo e(trans('labels.email')); ?> <span class="require">*</span></label>
                      <input type="text" id="email" name="email" class="form-control" data-bvalidator="required,maxlen[100]" value="<?php echo e($edit['item']->email); ?>">
                    </div>
              </div>
             <!--  <div class="col-sm-6">
                <div class="form-group">
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/edit-item.blade.php ENDPATH**/ ?>