...
<?php if($errors->any()): ?>
                       ...
                       <div class="card">
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="card-body">
                             ...
                             <div class="form-group">
                                                <label for="banner_heading" class="control-label mb-1"><?php echo e(Helper::translation(5346,$translate)); ?> </label>
                                                <input id="site_banner_heading" name="site_banner_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_banner_heading); ?>" >
                                            </div>  
                                            
                              <div class="form-group">
                                                <label for="banner_heading" class="control-label mb-1"><?php echo e(Helper::translation(5349,$translate)); ?> </label>
                                                <input id="site_banner_subheading" name="site_banner_subheading" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_banner_subheading); ?>" >
                                            </div>              
                             ...
                             <div class="form-group">
                                            ...
                                            <input type="file" id="site_banner" name="site_banner[]" class="form-control-file" <?php if($setting['setting']->site_banner == ''): ?> required <?php endif; ?>  multiple="multiple" accept="image/jpg, image/jpeg">
                                            <?php if($setting['setting']->site_banner != ''): ?>
                                                <div class="uploaded-img-cls">
                                                    <?php @$sitebanner=explode(",",$setting['setting']->site_banner); ?>
                                                    <?php $__currentLoopData = @$sitebanner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="img-close-btn">
                                                            <i class="fa fa-times" onclick="deleteimg('<?php echo $value;?>','<?php echo $setting['setting']->site_banner; ?>','banner',this)"></i>
                                                            <img height="30" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($value); ?>" />
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="watermark_option" id="watermark_option" class="form-control" required>
                                                <option value=""></option>
                                            ...
                                            <?php if($setting['setting']->site_watermark != ''): ?>
                                                <img height="150" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->site_watermark); ?>" id="removeimg"/>
                                               
                                                <input type="button" name="delete" onClick="Deleteimg('<?php echo $setting['setting']->site_watermark; ?>',this,'watermark')" value="Deldete" />
                                                <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                 <label for="site_loader_image" class="control-label mb-1">Staff Favourite Images (200 X 200)<span class="require">*</span></label>
                                               
                                                  <input type="file" id="site_loader_image" name="stafffav_image" class="form-control-file" <?php if($setting['setting']->stafffav_image == ''): ?> data-bvalidator="required,extension[gif,jpg,png,jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(5376,$translate)); ?>" <?php else: ?> data-bvalidator="extension[gif,jpg,png,jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(5376,$translate)); ?>" <?php endif; ?>>
                                                <?php if($setting['setting']->stafffav_image != ''): ?>
                                                     <img height="50" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($setting['setting']->stafffav_image); ?>" />
                                                <?php endif; ?>
                                                
                                             </div>

                                              <div class="form-group">
                                                 <label for="site_loader_image" class="control-label mb-1">Staff Favourite Images Content<span class="require">*</span></label>
                                               
                                                 <textarea id="staff_fav_content" name="staff_fav_content"  rows="6" class="form-control noscroll_textarea" required minlength="0" maxlength="100"><?php echo e($setting['setting']->staff_fav_content); ?></textarea>
 ...
 -->
                                              <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1"><?php echo e(trans('labels.calltoactiontext')); ?><span class="require">*</span></label>
                                                
                                            <textarea name="calltoactiontext" id="calltoactiontext" rows="6" class="form-control noscroll_textarea" required><?php echo e($setting['setting']->calltoactiontext); ?></textarea>
                                            </div>  
                                                ...
                                                <input type="hidden" name="save_watermark"  id="save_watermark" value="<?php echo e($setting['setting']->site_watermark); ?>">
                                                <input type="hidden" name="save_loader_image" value="<?php echo e($setting['setting']->site_loader_image); ?>">
                                                 <input type="hidden" name="save_stafffav_image" value="<?php echo e($setting['setting']->stafffav_image); ?>">
                                                <input type="hidden" name="sid" value="1">
                                                <input type="hidden" name="cid" id="cid" value="<?php echo e($setting['setting']->sid); ?>">
...
<script>
    $("#site_banner").on("change", function() {
    if ($("#site_banner")[0].files.length > 6) {
    ...
    function Deleteimg(imgname,obj,type){
        ...
        jQuery.ajax({
                ...
                url: "<?php echo e(url('/admin/delete-general-settings-water')); ?>",
                method: 'post',
                data: {
    ...
    //type banner or watermark
   function  deleteimg(delbanner,banner,type,obj){
