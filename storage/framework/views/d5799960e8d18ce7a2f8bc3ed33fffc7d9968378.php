                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/add-vendor')); ?>" class="btn btn-success btn-sm dropbtn"><i class="fa fa-plus"></i> <?php echo e(Helper::translation(5055,$translate)); ?></a> |
                      
                            <a href="<?php echo e(url('/admin/vendor-import-export/xlsx')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-download"></i> <?php echo e(trans('labels.export')); ?></a> |

                            <a href="<?php echo e(url('/admin/vendor-import-export')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo e(trans('labels.import')); ?></a>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php $__currentLoopData = $userData['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                           ...
                                           <!--  <td><?php if($user->exclusive_author == 1): ?> <span class="badge badge-success"><?php echo e(Helper::translation(5883,$translate)); ?></span> <?php else: ?> <span class="badge badge-danger"><?php echo e(Helper::translation(5886,$translate)); ?></span> <?php endif; ?></td>
                                            ...
                                            <!-- <a href="paymentsetting/<?php echo e($user->id); ?>" class="btn btn-warning btn-sm" >&nbsp;<?php echo e(trans('labels.paymentsetting')); ?></a> -->
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/vendor.blade.php ENDPATH**/ ?>