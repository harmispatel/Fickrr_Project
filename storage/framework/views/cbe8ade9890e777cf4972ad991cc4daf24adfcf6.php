                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                        <form action="<?php echo e(route('admin.upload-designer')); ?>" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(trans('labels.designername')); ?><span class="require">*</span></label>
                                                 <input type="text" name="designername" id="designername"   placeholder="<?php echo e(trans('labels.designername')); ?>" required="true"  value="" class="form-control" >
                                            </div> 
                                            
                                            <div class="form-group">
                                               <label for="about" class="control-label mb-1"><?php echo e(trans('labels.about')); ?><span class="require">*</span></label>
                                                <textarea name="about" id="about" rows="6"  class="form-control" data-bvalidator="required"></textarea>
                                            
                                            </div>

                                            <div class="form-group">
                                                <label for="email" class="control-label mb-1"><?php echo e(trans('labels.email')); ?><span class="require">*</span></label>
                                                <input name="email" id="email" type="email"  class="form-control" data-bvalidator="required" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="socialmedialinks" id="socialmedialinks" type="text"  class="form-control" />
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/upload-designer.blade.php ENDPATH**/ ?>