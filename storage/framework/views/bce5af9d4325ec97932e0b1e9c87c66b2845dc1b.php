                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.vppayment-settings')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden"  name="itemid" id="itemid" value="<?php echo e($itemid); ?>" />
                        <input type="hidden"  name="sid" id="sid" value="<?php if(!empty($setting['setting'])): ?> <?php echo e($setting['setting']->sid); ?> <?php endif; ?>" />  
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(5724,$translate)); ?> </label><br/>
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/vendorpayment-settings.blade.php ENDPATH**/ ?>