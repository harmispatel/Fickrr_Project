...
<section class="bg-position-center-top" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_banner); ?>');">
      <div class="container d-flex flex-column">
        ...
        <h2 class="mb-4 pt-5 title-page text-white"><?php echo e(Helper::translation(2993,$translate)); ?></h2>
        <h3 class="lead mb-5 text-white"><?php echo e(Helper::translation(2994,$translate)); ?></h3>
    </div>
</div>
<div class="row">
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/flash-sale.blade.php ENDPATH**/ ?>