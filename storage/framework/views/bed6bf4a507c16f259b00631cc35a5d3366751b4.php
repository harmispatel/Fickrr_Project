            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(trans('labels.vendorstoreimportexport')); ?> </h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="<?php echo e(url('/admin/products-import-export/xlsx')); ?>" class="btn btn-success btn-sm"><i class="fa fa-download"></i> Vendor store export</a>&nbsp;
                         </ol>
                    </div>
                </div>
            </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           <?php else: ?>
                           <form action="<?php echo e(route('admin.items-import-export')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/items-import-export.blade.php ENDPATH**/ ?>