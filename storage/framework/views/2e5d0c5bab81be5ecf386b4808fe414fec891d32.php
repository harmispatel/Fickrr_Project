      ...
      <div class="bg-light box-shadow-lg rounded-lg overflow-hidden">
        <div class="row">
          ...
          <section class="col-lg-8 pt-lg-4 pb-md-4">
            ...
            <h2 class="h3 pt-2 pb-4 mb-4 text-center text-sm-left border-bottom"><?php if($followercount <= 1): ?> <?php echo e(Helper::translation(3198,$translate)); ?> <?php else: ?> <?php echo e(Helper::translation(3197,$translate)); ?> <?php endif; ?><span class="badge badge-secondary font-size-sm text-body align-middle ml-2"><?php echo e($followercount); ?></span></h2>
        <div class="row pt-2">
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user-followers.blade.php ENDPATH**/ ?>