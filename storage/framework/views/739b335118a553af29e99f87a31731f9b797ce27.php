...
<script src="<?php echo e(URL::to('resources/views/customtheme/assets/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-slider/10.0.0/bootstrap-slider.min.js"></script> 
 <script src="<?php echo e(URL::to('resources/views/customtheme/assets/vendor/OwlCarousel/owl.carousel.min.js')); ?>"></script> 

<script src="<?php echo e(URL::to('resources/views/customtheme/assets/js/main.js')); ?>"></script>
...
<script type="text/javascript">
	...
	$(this).cPager({
     ...
     var src = "<?php echo e(route('searchajaxhotel')); ?>";
...
<?php if($view_name == 'user-checkout'): ?>
...
<script src="<?php echo e(URL::to('resources/views/theme/validate/themes/red/red.js')); ?>"></script>  --><?php /**PATH D:\xampp\htdocs\fickrr\resources\views/user/common/scripts.blade.php ENDPATH**/ ?>