            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(5049,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="cat_id" class="form-control" required>
                                                        ...
                                                        <?php $__currentLoopData = $categoryData['category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($category->cat_id); ?>_0" style="font-weight: bold !important;font-size: 16px;"><?php echo e($category->category_name); ?></option>
                                                            ...
                                                            <?php 
                                                                ...
                                                                if( count ($value) > 0 ){
                                                                    foreach($value as $key=>$value1){ ?>
                                                                        ...
                                                                        <option value="<?php echo e($value1->subcat_id); ?>_<?php echo e($category->cat_id); ?>"> - <?php echo e($value1->subcategory_name); ?></option>
...
<?php /**PATH D:\xampp\htdocs\fickrr\resources\views/admin/add-subcategory.blade.php ENDPATH**/ ?>